...
const publicacionesCursosRouter_1 = __importDefault(require("./routes/publicacionesCursosRouter"));
...
class server {
    ...
    routes() {
        ...
        this.app.use('/verCursosPublicaciones', publicacionesCursosRouter_1.default);
    }
